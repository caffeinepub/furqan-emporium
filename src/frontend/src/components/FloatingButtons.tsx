  ...
  return (
    <>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full flex items-center justify-center transition-transform hover:scale-110"
        style={{
          background:
            "linear-gradient(135deg, var(--gold-start), var(--gold-end))",
          boxShadow: "0 4px 20px rgba(212,175,55,0.5)",
        ...
        data-ocid="floating.instagram.button"
      >
        <Instagram size={24} color="#1A1A1A" strokeWidth={2} />
      </a>
    </>
  );
}
